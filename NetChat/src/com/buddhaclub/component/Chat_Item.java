...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/buddhaclub/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/buddhaclub/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.buddhaclub.swing.JIMSendTextPane();
    ...
    private com.buddhaclub.swing.JIMSendTextPane txt;
