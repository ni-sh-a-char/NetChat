...
public class Chat_Left_With_Profile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new com.buddhaclub.swing.ImageAvatar();
        txt = new com.buddhaclub.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/buddhaclub/icon/testing/dog.jpg"))); // NOI18N
    ...
    private com.buddhaclub.swing.ImageAvatar IaImage;
    private javax.swing.JLayeredPane jLayeredPane1;
    private com.buddhaclub.component.Chat_Item txt;
