...
import com.buddhaclub.app.MessageType;
import com.buddhaclub.emoji.Emogi;
import com.buddhaclub.emoji.Model_Emoji;
import com.buddhaclub.event.PublicEvent;
import com.buddhaclub.main.Main;
...
import com.buddhaclub.swing.WrapLayout;
...
public class Panel_More extends javax.swing.JPanel {
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/buddhaclub/icon/image.png")));
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/buddhaclub/icon/link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();
