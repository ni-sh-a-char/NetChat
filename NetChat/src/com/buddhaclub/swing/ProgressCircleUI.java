...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/buddhaclub/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/buddhaclub/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/buddhaclub/icon/file.png")).getImage();
    }
